...
# docker-compose exec website snakeeyes babel extract
# docker-compose exec website snakeeyes babel init --language kl
# docker-compose exec website snakeeyes babel update
# docker-compose exec website snakeeyes babel compile
